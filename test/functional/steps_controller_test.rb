...
class StepsControllerTest < ActionController::TestCase
  ...
  test "should show new" do
    xhr :get, :new, :account_id => @account, :site_id => @site.to_param, :health_check_id => @health_check.to_param, :type => 'visit'
    assert_response :success
  ...
  test "should delete step" do
    ...
    assert_difference 'Step.count', -1 do
      assert_redirected_back do
        delete :destroy, :account_id => @account, :site_id => @site.to_param, :health_check_id => @health_check.to_param, :id => step
      end
    end
  end
  ...
  test "should sort steps" do
    ...
    post :sort, :account_id => @account, :site_id => @site.to_param, :health_check_id => @health_check.to_param, :step => [step3.id, step1.id, step2.id]
