...
class UsersControllerTest < ActionController::TestCase
  ...
  test "should create user" do
    assert_difference 'User.count' do
      post :create, :locale => 'en', :user => { :full_name => "John Doe", :password => "12345", :password_confirmation => "12345", :email => "john@doe.com" }
    end
  ...
  test "should not create invalid user" do
    assert_no_difference 'User.count' do
      post :create, :locale => 'en', :user => { :full_name => nil, :password => "54321", :password_confirmation => "12345", :email => "john@doe.com" }
    end
  ...
  test "should not update invalid user" do
    ...
    put :update, :locale => 'en', :id => john.id, :user => { :full_name => nil }
    assert_response :success
  end
  ...
  test "should register additional user for account" do
    ...
    assert_difference 'User.count' do
      assert_difference 'UserAccount.count' do
        post :create, :locale => 'en', :user => { :full_name => "Jane Doe", :password => "12345", :password_confirmation => "12345", :email => "jane@doe.com" }
        assert_response :redirect
      end
    end
  end
