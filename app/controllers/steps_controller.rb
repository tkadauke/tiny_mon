...
protected
  def step_params
    params.require(params[:type]+'_step').permit(:id, :url, :duration, :content, :count, :dateformat, :field, :value, :negate, :name, :scope, :mincount, :maxcount)
  end

  def step_update_params type
    params.require(type.underscore.to_sym).permit(:id, :url, :duration, :content, :count, :dateformat, :field, :value, :negate, :name, :scope, :mincount, :maxcount)
  end
